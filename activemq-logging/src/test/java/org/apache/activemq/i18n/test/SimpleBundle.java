...
@Bundle(projectCode = "TST")
public interface SimpleBundle extends BaseHack
{
   SimpleBundle MESSAGES = I18NFactory.getMessageBundle(SimpleBundle.class);
   ...
   @LogMessage(level = LogMessage.Level.DEBUG, id = 5, value = "This is a print!!!")
   void printMessage();

   @LogMessage(level = LogMessage.Level.DEBUG, id = 6, value = "This is a print!!! {0}")
